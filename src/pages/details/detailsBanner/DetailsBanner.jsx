...
import CircleRating from "../../../components/circleRating/CircleRation.jsx";
                    ...
                    {!!data && (
                        <React.Fragment>
                            <div className="backdrop-img">
                                <Img source={url?.backdrop + data?.backdrop_path} />
                            </div>
                            ...
                            <ContentWrapper>
                                <div className="content">
                                    <div className="left">
                                        {data?.poster_path ? (
                                            <Img className={'posterImg'} source={url?.backdrop + data?.poster_path} />
                                        ) : (<Img source={PosterFallback} />)}
                                    </div>
                                    <div className="right">
                                        <div className="title">
